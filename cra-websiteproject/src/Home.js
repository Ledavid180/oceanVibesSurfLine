...
const Home = () => {
    return(
        <>
        <video class="img-responsive videocover videocoverpaddding" muted="" autoplay="" loop="" poster="https://www.haydenshapes.com/wp-content/themes/haydenshapes/media/loop-tracks-short-poster.jpg">
                    <source src="https://www.haydenshapes.com/wp-content/themes/haydenshapes/media/loop-tracks-short-poster.webm" type="video/webm" />
                    <source src="https://www.haydenshapes.com/wp-content/themes/haydenshapes/media/loop-tracks-short-poster.mp4" type="video/mp4" />
                     </video> 
                     {/* Issues with pushing video under Header. Cannot select Routes */}
            <div class="row">
                <div class="greeting col-sm-12">
                    <h1>Design. Performance. Innovation. Art.</h1>
                </div>
            </div>  */
            <main>
